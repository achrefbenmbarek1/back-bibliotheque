...
public class livre {
    ...
    @Column private String imageDeCouverture;
	...
	public livre(Integer idLivre, String name, String auteur, String titre, String genre, String langue, float prix, String imageDeCouverture) {
		this.idLivre = idLivre;
		this.name = name;
		this.auteur = auteur;
		this.titre = titre;
	...
	public livre( String name, String auteur, String titre, String genre, String langue, float prix, String imageDeCouverture) {
		this.name = name;
		this.auteur = auteur;
		this.titre = titre;
		this.genre = genre;
